                ...
                {isFormSubmitted ? (
                  ...
                  <form ref={formRef} onSubmit={handleSubmit}>
                    ...
                    <button
                      ...
                      className="group w-full bg-primary text-white px-8 py-4 rounded-lg hover:bg-primary-light transition-colors text-base font-medium flex items-center justify-center disabled:opacity-70 disabled:cursor-not-allowed"
                    >
                      {isSubmitting ? (
                        <>
